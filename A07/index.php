...
<body>
    ...
    <div class='card'>
        <img src='" . htmlspecialchars($imagePath) . "' class='card-img-top' alt='Feed Image'>
        <div class='card-body'>
            ...
            <div class='post-icons'>
                ...
                <a href='delete_post.php?postID=" . $row['postID'] . "' class='btn btn-danger btn-sm' onclick='return confirm(\"Are you sure you want to delete this post?\");'>Delete</a>
                <!-- Edit Button -->
                <button class='btn btn-warning btn-sm' data-toggle='modal' data-target='#editModal-" . $row['postID'] . "'>Edit</button>
            </div>
        </div>
    </div>
</div>";
...
echo "<div class='modal fade' id='editModal-" . $row['postID'] . "' tabindex='-1' role='dialog' aria-labelledby='editModalLabel' aria-hidden='true'>
